  ...
  class Application < Hanami::Application
    configure do
      ...
      security.content_security_policy %{
        ...
        base-uri 'self';
        default-src 'none';
        script-src 'self' 'unsafe-inline' https://mc.yandex.ru/ https://code.jquery.com https://cdnjs.cloudflare.com https://maxcdn.bootstrapcdn.com https://cdn.jsdelivr.net http://platform.instagram.com/;
